//filter
/* 
filter digunakan untuk mengembalikan nilai dalam array object lebih dari satu
...
const evenNumbers = numbers.filter((number) => {
  return number % 2 === 0; //disini kita akan megembalikan nilai yang bisa dibagi 2
});
...
const underTwenty = characters.filter((character) => {
  ...
  return character.age < 20; //sama seperti diatas di array object ini kita akan menampilkan    
});                          //nilai umur yang kurang dari 20 dengan jumlah lebih dari 1
